...
#she's all like "hmmmm"
 ...
 "You look out at the distant surroundings, as butterflies float around the slightly withered potted plants someone left up here."
 m "It's really pretty right?"
 ...
 m "You see how they look like the belt of this kinda stick man guy?"
 ali "...What are you talking about?"
 ali "All I see is white specks."
 m "Yeah constallations are kind of hard to see until you see them"
 ali "Constipations?"
 m "Constallations are pictures that people from thousands of years saw."
 m "They mostly gods, and animals and stuff"
ali "So no mushrooms?"
m "I.. don't think so?"
ali "I see..."
ali "What's the point though? Like what do they do?"
m "Uh... Nothing I think."
ali "So why do you guys care?"
"You think in silence for a second, trying to find a response that makes sense"
m "Throughout the year, the night sky changes slowly"
m "But the same shapes show up again and again"
m "I think people just want to find some kind of meaning out of that unchanging pattern"
m "We like that... For things to make sense. To have a pattern, that we can understand"
ali "I see."
m "Maybe now you see the rooftop isn't such a crappy place?"
ali "I don't know."
m "Well if you're ever feeling like you need some space and need some perspective, you should come out here"
ali "... I'll think about it..."
m "It's getting kinda cold... Let's go back inside."
