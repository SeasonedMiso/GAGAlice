...
# I think it's better that it's just about him being sexually harrassed
    ...
    m "..."
    m "I had a look over the website that I got your spores from before I went down to the enterance"
    ...
    ali "..."
    m "It's getting kinda late... Why don't we think about this more tomorrow?"
    ...
    "After a few seconds you feel the weight of the matress shift and the duvet being lifted"
    m "What are you doing??!!"
    ali "? If you're going to bed, I was just getting in to spend the night holding you"
    m blush
    m "Why?"
    ali "Well, that's what I'm supposed to do right?"
